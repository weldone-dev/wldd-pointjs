function PointJS(Va, Wa, Xa, Sc) {
    ...
    var k = window, A = this, K = !1, Ea = "fixed", Vb = 0, Wb = 0, Ab = 100, Xb = function (a) {
    ...
    var Fa = !0, Bb = !0, Zb = !0, ja = !1, Ga = !0, m = Va, n = Wa, na = Va, oa = Wa,
    ...
    this.system.setSettings =
        function (a) {
            Fa = w(a.isShowError) ? a.isShowError : !0;
            Bb = w(a.isStopForError) ? a.isStopForError : !0;
    ...
    this.system.setSmoothing = function (a) {
        Ga = a;
        h.msImageSmoothingEnabled = Ga;
        h.imageSmoothingEnabled = Ga
    };
    ...
    this.vector.getAngle2Points = Ha;
    ...
    this.vector.moveCollision = function (a, b, c, f, d, e) {
        ...
        for (m = 2 + h.y; 0 <= k; k--) if (h = b[k], h.visible && a !== h && !(d && !h.isInCameraStatic() || e && a.getDistanceC(h.getPositionC()) >
            ...
            E.h >= l.y + m && E.y <= l.h - m && (0 <= c.x ? Ia(E.w, l.x, l.w) && (a.x = l.x - (a.w + a.box.w + a.box.x) + 1, c.x = 0, u = !0) : 0 > c.x && Ia(E.x, l.x, l.w) && (a.x = l.w - a.box.x - 1, c.x = 0, u = !0));
            E.w >= l.x + n && E.x <= l.w - n && (0 < c.y ? Ia(E.h, l.y, l.h) && (a.y = l.y - (a.h + a.box.h + a.box.y) + 1, c.y = 0, g = !0) : 0 > c.y && Ia(E.y, l.y, l.h) && (a.y = l.h - a.box.y - 1, c.y = 0, g = !0));
            f && f(a, h, u, g)
        }
        a.move(c)
    };
    this.vector.moveCollisionAngle = function (a, b, c, f, d, g, h) {
        ...
        for (var E; c < d; c += 1) if (E = b[c], !g || E.isInCamera()) if (!h || !a.getDistanceC(E.getPositionC())) {
            ...
            if (a.isIntersect(E)) {
                var l = a.getStaticBox(), $a = Math.abs(u.x), m = Math.abs(u.y);
                l.x + l.w > k.x + 10 + $a && l.x < k.x + k.w - 10 - $a && (0 < u.y && l.y + l.h < k.y + k.h / 2 + m ? u.y = 0 : 0 > u.y && l.y > k.y + k.h - k.h / 2 - m && (u.y = 0));
                l.y + l.h > k.y + 10 + m && l.y < k.y + k.h - 10 - m && (0 < u.x && l.x + l.w < k.x + k.w / 2 + $a ? u.x = 0 : 0 > u.x && l.x > k.x + k.w - k.w / 2 - $a && (u.x = 0));
                f && f(a, E)
            }
        }
        a.move(u);
    ...
    var $b = {}, Cb = function () {
        ...
        var c = (sa.canvas || (sa.canvas = document.createElement("canvas"))).getContext("2d");
        "number" == typeof b ? c.font = b + "px serif" : "string" == typeof b && (c.font = b);
    ...
    var cc = 0, l = {
        ...
        remove: function (a) {
            ...
            l.loaded ? b() : l.addEvent("onload", "attachElement_PointJS" +
                (cc += 1), b)
        },
        getWH: function () {
            return {
    ...
    var h = null, bc = null, Ja = e(Vb, Wb);
    var q = k.document.createElement("canvas");
    bc = h = q.getContext("2d");
    h.textBaseline = t.textBaseline;
    q.crossOrigin = "anonymous";
    q.width = parseInt(Va);
    q.height = parseInt(Wa);
    q.style.position = Ea;
    K ? (q.style.left = Ja.x + "px", q.style.top = Ja.y + "px", l.addEvent("gameResize", "initedCanvasResize", function () {
        var a = Xb(K);
    ...
    if ("object" === typeof Xa) for (var Fb in Xa) Fb.match(/margin|padding|position/) || (q.style[Fb] = Xa[Fb]);
    ...
    var Y = !1, Ic = function () {
        Y || (this.requestFullscreen ? (this.requestFullscreen(), Y = !0) : this.mozRequestFullScreen ? (this.mozRequestFullScreen(), Y = !0) : this.webkitRequestFullscreen && (this.webkitRequestFullscreen(), Y = !0), m = l.getWH().w, n = l.getWH().h, H = m / 2, I = n / 2, q.width = m, q.height = n, r.style.width = m + "px", r.style.height = n + "px", ta())
    }, Gb = function (a) {
        Y = dc(k.document.fullscreenElement ||
            k.document.mozFullScreenElement || k.document.webkitFullscreenElement)
    };
    k.document.addEventListener("webkitfullscreenchange", Gb);
    k.document.addEventListener("mozfullscreenchange", Gb);
    k.document.addEventListener("fullscreenchange", Gb);
    ...
    this.system.exitFullScreen = function () {
        Y && (l.delEvent("gameResize", "PointJS_initFullScreen"), k.document.exitFullscreen ? (k.document.exitFullscreen(), Y = !1) : k.document.mozCancelFullScreen ? (k.document.mozCancelFullScreen(), Y = !1) : k.document.webkitExitFullscreen && (k.document.webkitExitFullscreen(), Y = !1), m = na, n = oa, H = m / 2, I = n / 2, q.width = m, q.height = n, r.style.width = m + "px", r.style.height = n + "px", ta(), k.document.documentElement.onclick = function () {
        })
    };
    ...
    this.system.exitFullScale = function () {
        Ka && (Ka = !1, l.delEvent("gameResize", "PointJS_initFullScale"), q.style.width = na + "px", q.style.height = oa + "px", r.style.width = na + "px", r.style.height = oa + "px")
    };
    ...
    this.keyControl.getKeyList = function () {
        var a, b = [];
        for (a in ab) b.push(a);
        return b
    };
    var aa = {}, La = {}, ua = {}, Ma = !1, Na = !1, bb = !1, cb = !1, Kc = function (a) {
        G(ua, function (a, c, f) {
            1 == a && (f[c] = 2)
        })
    };
    ...
    this.keyControl.initControl = this.keyControl.initKeyControl = function () {
        ...
        k.onkeydown = function (a) {
            if (bb) return Na = a.keyCode, Jc[a.keyCode] ? (a.preventDefault(), !1) : !0;
            a.preventDefault();
            2 != ua[a.keyCode] && (ua[a.keyCode] = 1, cb = a.keyCode, D.run("key:press", Aa[a.keyCode]));
            aa[a.keyCode] = !0;
            return !1
        };
        ...
        k.onkeyup = function (a) {
            a.preventDefault();
            1 == aa[a.keyCode] && (La[a.keyCode] =
                !0);
            aa[a.keyCode] = !1;
            D.run("key:up", Aa[a.keyCode]);
            delete ua[a.keyCode];
            delete aa[a.keyCode];
            return !1
        };
        ...
        l.addEvent("preLoop", "PointJS_KeyDownEvent", function () {
            D.isEvent("key:down") && G(aa, function (a, b) {
                a && D.run("key:down", Aa[b])
            })
        });
        return this
    };
    var Oa = !1, x = e(0, 0), db = e(0, 0);
    e(0, 0);
    var Pa = !0, eb = "", fb = !1, va = e(0, 0), gb = !1, Ib = {LEFT: 1, RIGHT: 3, MIDDLE: 2},
        Jb = {1: "LEFT", 3: "RIGHT", 2: "MIDDLE"}, hb = !1, ib = {}, jb = {}, Qa = {}, Ba = 0, hc = function () {
            ib =
                {};
            jb = {};
            Qa = {};
    ...
    this.mouseControl.setCursorImage = function (a) {
        a = "url('" + a + "'), auto";
        if (eb !== a) return eb = a, k.document.body.style.cursor = eb
    };
    this.mouseControl.setVisible = function (a) {
        !Pa && !a || Pa && a || (Pa = 1 == a, k.document.body.style.cursor = Pa ? eb : "none")
    };
    ...
    this.mouseControl.isWheel = function (a) {
        return "UP" === a && 0 < Ba || "DOWN" === a && 0 > Ba
    };
    var ic = function (a) {
        a.preventDefault();
        Ba = a.wheelDelta ? a.wheelDelta : -a.detail;
        D.run("mouse:wheel", 0 > Ba ? "DOWN" : "UP");
        return !1
    }, lb = !1, jc = function () {
        lb && (fb = w(k.document.pointerLockElement) || w(k.document.mozPointerLockElement) ? !0 : !1)
    };
    this.mouseControl.initMouseLock = function () {
        l.addEvent("onload", "initPointerLock", function () {
            lb = r.requestPointerLock || r.mozRequestPointerLock || !1;
            k.document.exitPointerLock =
                k.document.exitPointerLock || k.document.mozExitPointerLock || !1;
            ...
            if (!lb) return ea("error in initMouseLock : not supported");
            fb || (r.onclick = lb)
        })
    };
    ...
    this.mouseControl.initControl = this.mouseControl.initMouseControl = function () {
        ...
        r.onmousemove = function (a) {
            ...
            if (fb) {
                ...
                x.y += b
            } else x.x = a.pageX - Ja.x, x.y = a.pageY - Ja.y, Z && (x.x /= Z.w, x.y /= Z.h);
            x.x /= pa;
            x.y /= qa;
            va.x = x.x - db.x;
            va.y = x.y - db.y;
    ...
    var Kb = !1, Ra = !1, mb = 0, nb = 0, L = 0, M = 0, y = e(0,
        0), ob = [], Sa = e(0, 0), pb = e(0, 0);
    ...
    this.colors.randomColor = function (a, b, c) {
        return qb(S(a, b), S(a, b), S(a, b), c || 1)
    };
    ...
    var w = function (a) {
        ...
        var f, d;
        for (f in a) if ((!c || a.hasOwnProperty(f)) && "undefined" !== typeof a[f] &&
    ...
    var mc = function (a) {
        ...
        var c = !1, f = Cb(), d = !1, e = new XMLHttpRequest, g = function () {
            e.open("GET", a, !0);
            e.send()
        };
        ...
        this.start = function () {
            a =
                a.match(/\?/) ? a + ("&session_id=" + f) : a + ("?session_id=" + f);
            g();
            c = !0
        };
    ...
    var Ta = 60, O = Date.now(), rb = 0, sb = -1, oc = O, ka = {}, tb = 0;
    ...
    var pc = function () {
        return k.requestAnimationFrame || k.webkitRequestAnimationFrame || k.mozRequestAnimationFrame ||
            k.oRequestAnimationFrame || k.msRequestAnimationFrame || function (a) {
                k.setTimeout(a, 1E3 / Ta)
            }
    }, Ca = pc(), qc = function () {
        O = Date.now();
    ...
    var Mb = function () {
        ...
        ja || (ja = !0, Ta = a || 60, Ca(Mb), l.runEvent("gameStart"))
    }, la = function (a) {
        ja && (ja = !1, sc(), Ca = function () {
            "undefined" !== typeof a && ea(a)
        }, l.runEvent("gameStop"))
    };
    ...
    this.game.resume = function () {
        if (!ja) return P.audio && P.audio[0].play(), Ca = pc(), sb = -1, tc(), !1
    };
    var Oc = 0, F = function (a) {
        ...
        this.__dataset__ = {};
        this.setShadow(a);
        "object" === typeof a.data && G(a.data, function (a, c) {
            this.dataSet(c, a)
        }, !0);
    ...
    F.prototype = {
        ...
        getParent: function () {
            ...
            uc(e(this.x + this.w / 2 + this.center.x, this.y + this.h / 2 + this.center.y),
                10, d || "yellow")
            ...
            h.shadowColor = "transparent";
            ba(e(this.x + this.box.x + 1 + (a || 0), this.y + this.box.y + 1 + (b || 0)), z(this.w + this.box.w - 1 + (c || 0), this.h + this.box.h - 2 + (f || 0)), !1, d || "red", 2)
        ...
        getAlpha: function () {
            ...
            var c = Ha(this.getPositionC(), a.getPositionC());
            this.rotateForAngle(c, b)
        }, moveTo: function (a, b) {
            var c = C(Ha(this.getPosition(), a));
            this.x += b * Math.cos(c);
            this.y += b * Math.sin(c)
        }, moveToC: function (a, b, c) {
            a = C(Ha(this.getPositionC(), a));
            this.x += b * Math.cos(a);
            this.y += c * Math.sin(a)
        ...
        isInCamera: function () {
            ...
            var a = this.getDynamicBox(), b = [e(g.x, g.y), e(g.x + m, g.y), e(g.x + m, g.y + n), e(g.x, g.y + n)], c,
                f = 0;
            var d = 0;
    ...
    fa(F, vb);
    vb.prototype.getDynamicBox = function () {
        var a = this.getPositionC();
        return 0 === this.angle ? [e(this.x + this.w / 2, this.y), e(this.x + this.w, this.y + this.h), e(this.x, this.y + this.h)] : [J(e(this.x + this.w / 2, this.y), a, this.getAngle()), J(e(this.x + this.w, this.y + this.h), a, this.getAngle()), J(e(this.x, this.y + this.h), a, this.getAngle())]
    };
    vb.prototype.draw = function () {
        this.predraw();
        if (this.visible && this.alpha) {
            var a = !1;
            if (this.angle || 1 !== this.alpha || this.shadowColor) T(this), a = !0;
            Ua(this.x, this.y, [e(this.w / 2, 0), e(this.w,
                this.h), e(0, this.h)], this.fillColor, this.strokeWidth ? this.strokeColor : !1, this.strokeWidth);
    ...
    Ob.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            var a = !1;
            if (this.angle || 1 !== this.alpha || this.shadowColor) T(this), a = !0;
            wb(e(this.x, this.y), z(this.w, this.h), this.radius, this.fillColor, this.strokeColor, this.strokeWidth);
            if (this.ondraw) this.ondraw();
            a && Q()
        }
    };
    ...
    Pb.prototype.draw = function () {
        if (this.loaded) {
            ...
            for (f = 0; f < this.countY; f += 1) if (!(this.y + f * this.h + this.h <
    ...
    Qb.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            T(this);
            Da(e(this.x, this.y), this.h / 2, this.fillColor,
    ...
    var ca = function (a) {
        ...
        this.w = sa(this.text, this.style, this.size, this.font) + 2 * this.padding;
        this.h =
    ...
    ca.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            var a = !1;
            if (this.angle ||
                1 !== this.alpha || this.shadowColor) T(this), a = !0;
            if (this.fillColor || this.strokeColor) this.radius ? wb(e(this.x, this.y), z(this.w, this.h), this.radius, this.fillColor, this.strokeColor, this.strokeWidth) : ba(e(this.x, this.y), z(this.w, this.h), this.fillColor, this.strokeColor, this.strokeWidth);
            wa(e(this.x + this.padding, this.textDY + this.y + this.padding), this.text, this.color, this.size, this.font, this.style, this.align, this.strokeColorText, this.strokeWidthText);
            if (this.ondraw) this.ondraw();
            a && Q()
        }
    };
    ...
    this.OOP.getTextWidth =
        function (a) {
            return sa(a.text, a.style || "", a.size || 10, a.font || "serif")
        };
    ...
    U.prototype.drawDynamicBox = function (a) {
        Ua(this.x, this.y, this.points, !1, "yellow", 1, "red")
    };
    U.prototype.getDynamicBox = function () {
        for (var a = [], b = this.points.length - 1; 0 <= b; b--) a.push(J(this.points[b], e(this.w /
            2 + this.center.x, this.h / 2 + this.center.y), this.angle).plus(e(this.x, this.y)));
        return a
    };
    U.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            var a = !1;
            if (this.angle || 1 !== this.alpha || this.shadowColor) T(this), a = !0;
            Ua(this.x, this.y, this.points, this.fillColor, this.strokeColor, this.strokeWidth, this.pointColor);
            if (this.ondraw) this.ondraw();
            a && Q()
        }
    };
    ...
    R.prototype.draw = function () {
        if (this.visible && this.alpha) {
            ...
            if (this.ondraw) this.ondraw();
            this.difStep > this.step ? (this.frame = this.frame < this.anim.r ? this.frame + 1 : 0, this.difStep = 0) :
                this.difStep += 1;
            a && Q()
        }
    };
    R.prototype.drawFrames = function (a, b, c) {
        if (this.visible && this.alpha) {
    ...
    R.prototype.drawFrame = function (a) {
        if (this.visible && this.alpha) {
            var b = !1;
            if (this.angle ||
                1 !== this.alpha || this.flip.x || this.flip.y || this.shadowColor) T(this), b = !0;
    ...
    R.prototype.drawReverFrames = function (a, b) {
        if (this.visible && this.alpha) {
            this.drawFrame(this.frame);
            if (this.ondraw) this.ondraw();
    ...
    R.prototype.getDelay =
        function () {
            return this.step
        };
    R.prototype.getFrame = function () {
        return this.frame
    };
    ...
    var nc = function (a) {
        var b = !1;
        "RectObject" === a.type ? b = A.game.newRectObject({}) : "CircleObject" === a.type ? b = A.game.newCircleObject({}) : "RoundRectObject" === a.type ? b = A.game.newRoundRectObject({}) : "TextObject" === a.type ? b = A.game.newTextObject({}) : "EllipsObject" ===
        a.type ? b = A.game.newEllipsObject({}) : "ImageObject" === a.type ? b = A.game.newImageObject({file: a.file}) : "TriangleObject" === a.type ? b = A.game.newTriangleObject({}) : "PolygonObject" === a.type ? b = A.game.newTriangleObject({points: a.points}) : "AnimationObject" === a.type && (b = A.game.newAnimationObject({animation: a.anim}));
        return b
    ...
    ya.prototype.onContext = function (a) {
        this.loaded ? a(this.context, this.w, this.h, 1) : this.toLoad.push({w: this.w, h: this.h, r: 1, func: a})
    };
    ya.prototype.getCanvas = function () {
        return this.img
    };
    var Qc = 0;
    ya.prototype.getAnimation =
        function (a, b, c, f, d) {
    ...
    Tb.prototype.onContext = ya.prototype.onContext;
    Tb.prototype.getAnimation = ya.prototype.getAnimation;
    this.tiles.newDrawImage = function (a, b) {
        return new Tb(a, b)
    };
    this.tiles.newImage = function (a, b) {
        return Sb[a] ? Sb[a] : new ya(a, b)
    };
    this.tiles.newAnimation = function (a, b, c, f) {
        return (new ya(a)).getAnimation(0, 0, b, c, f)
    };
    var Rb = function (a, b, c, f) {
        if (a && a.image.loaded) {
            var d = -g.x, e = -g.y;
            a.image.img && h.drawImage(a.image.img, a.x + a.w * f, a.y, a.w,
        ...
        if (w(p[a])) {
            ...
            if (w(b)) {
                ...
                b.h ? (f = b.h / p[a].h, e = b.h, d = p[a].w * f) : b.w && b.h ? (d = b.w, e = b.h) : (d = p[a].w, e = p[a].h);
                c && (d *= c, e *= c);
                b.w = d;
                b.h = e;
                b.file = a;
    ...
    this.camera.setPosition = function (a) {
        Lb(e(!1 !== a.x ? a.x : g.x, !1 !== a.y ? a.y : g.y))
    };
    this.camera.setPositionC = function (a) {
        Lb(e(!1 !== a.x ? a.x - H : g.x, !1 !== a.y ? a.y - I : g.y))
    };
    ...
    var Ua = function (a, b, c, d, u, k, l) {
        if (!(3 > c.length)) {
            if (d && !(3 > c.length)) {
                ...
                for (E =
                         1; E < c.length; E += 1) h.lineTo(d + c[E].x, f + c[E].y);
                h.closePath();
                h.fill()
            }
    ...
    this.brush.drawPolygon = function (a) {
        ...
        if (!(3 > b.length)) {
            if (c && !(3 > b.length)) {
                ...
                for (l =
                         1; l < b.length; l += 1) h.lineTo(c + b[l].x, k + b[l].y);
                h.closePath();
                h.fill()
            }
    ...
    this.brush.drawTriangle = function (a) {
        ...
        Ua(a.x, a.y, [e(a.w / 2, 0), e(a.w, a.h), e(0, a.h)], a.fillColor, a.strokeColor, a.strokeWidth)
    };
    this.brush.drawTriangleS = function (a) {
        V(a);
        if (0 > a.x + a.w || a.x > m || 0 > a.y + a.h || a.y > n) return !1;
        Ua(g.x + a.x, g.y + a.y, [e(a.w / 2, 0), e(a.w, a.h), e(0, a.h)], a.fillColor, a.strokeColor,
            a.strokeWidth)
    };
    var wa = function (a, b, c, d, e, k, l, m, n) {
        h.textAlign = l;
        h.lineWidth = n;
        h.font = (k ? k + " " : "") + d + "px " + e;
        d = -g.x;
    ...
    this.brush.drawMultiText = function (a) {
        ...
        for (b = 0; b < c.length; b += 1) wa(e(a.x, a.y + a.size * b), c[b], a.color || t.fillStyle, a.size || 10, a.font || t.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2)
    };
    this.brush.drawMultiTextS = function (a) {
        var b, c = a.text.split("\n"),
            d = a.size || 10;
        for (b = 0; b < c.length; b += 1) wa(e(a.x + g.x, a.y + g.y + d * b), c[b], a.color || t.fillStyle, d || 10, a.font || t.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2)
    };
    this.brush.drawText = function (a) {
        wa(e(a.x || 0, a.y || 0), a.text, a.color || !1, a.size || 10, a.font || t.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2)
    };
    ...
    this.brush.drawTextLines = function (a) {
        if (a.lines) {
            var b, c = a.size || 10;
            for (b = 0; b < a.lines.length; b += 1) wa(e(a.x || 0, (a.y || 0) + c * b * a.lineHeight), a.lines[b], a.color || t.fillStyle, c, a.font || t.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2)
        }
    };
    this.brush.drawTextLinesS = function (a) {
        if (a.lines) {
            var b, c = a.size || 10;
            for (b = 0; b < a.lines.length; b += 1) wa(e((a.x || 0) + g.x, (a.y || 0) + g.y + c * b * a.lineHeight), a.lines[b], a.color || t.fillStyle, c, a.font || t.font, a.style || !1, a.align || "left", a.strokeColor ||
                !1, a.strokeWidth || 2)
        }
    };
    ...
    this.brush.drawRectS = function (a) {
        V(a);
        if (0 > a.x + a.w || a.x > m || 0 > a.y + a.h || a.y > n) return !1;
        ba(e(a.x + g.x, a.y + g.y), z(a.w, a.h), a.fillColor || !1, a.strokeColor || t.strokeStyle, a.strokeWidth || !1)
    };
    var xb = function (a, b) {
    ...
    this.brush.drawPoint = function (a) {
        ...
        xb(e(a.x, a.y), a.fillColor || !1)
    };
    this.brush.drawPointS = function (a) {
        V(a);
        if (0 > a.x || a.x > m || 0 > a.y || a.y > n) return !1;
        xb(e(a.x + g.x, a.y + g.y), a.fillColor || !1)
    };
    var wb = function (a, b, c, d, e, k) {
        h.fillStyle =
            d;
        h.strokeStyle = e;
        h.lineWidth = k;
    ...
    this.brush.drawRoundRectS = function (a) {
        V(a);
        if (0 > a.x + a.w || a.x > m || 0 > a.y + a.h || a.y > n) return !1;
        wb(e(g.x + a.x, g.y + a.y), z(a.w, a.h), a.radius || 2, a.fillColor || !1, a.strokeColor || t.strokeStyle, a.strokeWidth || !1)
    };
    ...
    this.brush.drawCircle =
        function (a) {
            ...
            Da(e(a.x, a.y), a.radius, a.fillColor || !1, a.strokeColor || t.strokeStyle, a.strokeWidth || !1)
        };
    this.brush.drawCircleS = function (a) {
        V(a);
        var b = 2 * a.radius;
        if (0 > a.x + b || a.x > m || 0 > a.y + b || a.y > n) return !1;
        Da(e(a.x + g.x, a.y + g.y), a.radius, a.fillColor || !1, a.strokeColor || t.strokeStyle, a.strokeWidth || !1)
    };
    ...
    this.brush.drawEllipsS = function (a) {
        ...
        h.scale(b / c, 1);
        h.translate(-d.x, -d.y);
        Da(e(g.x + a.x, g.y + a.y), c, a.fillColor, a.strokeColor, a.strokeWidth);
        h.restore()
    };
        ...
        if (a.file) if (w(p[a.file])) {
            if (p[a.file].loaded) {
                ...
                if (a.w && !a.h) {
                    ...
                    var e = a.w;
                    var g = p[a.file].h * d
                } else !a.w && a.h ? (d = a.h / p[a.file].h, g = a.h, e = p[a.file].w * d) : a.w && a.h ? (e = a.w, g = a.h) : (e = p[a.file].w, g = p[a.file].h);
    ...
    var W = k.AudioContext ||
        k.webkitAudioContext || !1;
    ...
    this.zList.useZValue =
        function () {
            this.update = function () {
                za.length = 0;
                v(yb, function (a) {
                    a.isInCamera() && za.push(a)
                });
                za.sort(function (a, b) {
                    return a.z - b.z
                })
            }
        };
    ...
    zb.clearCSSTransform = function (a) {
        a = (a ? a.canvas : q).style;
